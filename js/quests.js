...
window.QUESTS = [
  ...
  // ---- INTRICATE MULTI-STEP QUESTS -------------------------------------
  {
    id: "q-tideglass", name: "The Tideglass Prophecy", color: "#1f8f8a", icon: "🔱",
    house: { id: "house-oracle", name: "Maris's Tidehut", tx: 14, ty: 24, deco: "house2" },
    giverName: "Oracle Maris", giverAv: { skin: 2, hair: 6, shirt: 5, pants: 0, hat: "none", glasses: "round" },
    intro: "Beneath Lake Lumen lies the Sunken Sanctum — a drowned temple whose song was never finished. The Tideglass Prophecy foretells a clever trainer who will complete it and wake the light that sleeps below. The tides have been whispering your name. Will you help me finish the song?",
    steps: [
      { kind: "talk", npc: "npc-angler", npcName: "Angler Moss",
        line: "The old tide-word? Aye, my gran taught me. It's the answer to the lake's own riddle — solve it, and the Sanctum will hear you. Off you go back to Maris now.",
        text: "Seek Angler Moss by the southern marsh and learn the old tide-word." },
      { kind: "riddle", prompt: "I have a bed but never sleep, a mouth but never eat, I run but never walk, and I always find the sea. What am I?",
        answers: ["river", "a river"], hint: "It flows down to the sea.",
        giverLine: "Now speak the tide-word Angler Moss sent you for. Answer the lake's riddle!",
        text: "Return to Oracle Maris and speak the tide-word (answer the lake's riddle)." },
      { kind: "math", level: 3, giverLine: "Good! The temple's first lock is a number. Solve it exactly.",
        text: "Solve Oracle Maris's tide-cipher." },
      { kind: "item", item: "tide-token", itemName: "Tide Token", emoji: "🔷", count: 3, zone: "lake",
        text: "Gather 3 Tide Tokens shining along the shores of Lake Lumen." },
      { kind: "goto", loc: "portal-sanctum", locName: "the Tidewhirl", tx: 23, ty: 31, zone: "lake",
        text: "Step into the 🌀 Tidewhirl on the lake's western shore to descend into the Sunken Sanctum." },
      { kind: "catch", creature: "gillfin", zone: "sanctum",
        text: "A Gillfin guards the temple's inner doors — catch it to pass." },
      { kind: "item", item: "sanctum-sigil", itemName: "Sanctum Sigil", emoji: "🔱", count: 4, zone: "sanctum",
        text: "Collect 4 Sanctum Sigils glowing in the drowned halls." },
      { kind: "goto", loc: "loc-tidealtar", locName: "the Tideglass Altar", tx: 98, ty: 42, zone: "sanctum",
        text: "Carry the Sigils to the Tideglass Altar, deep in the Sanctum." },
      { kind: "boss", creature: "abyssalux", loc: "loc-tidealtar", tx: 98, ty: 42, zone: "sanctum",
        text: "Sing the finished Prophecy — Abyssalux, the leviathan of light, wakes! Catch it (its radiance will guard it)." },
    ],
    reward: { xp: 750, orbs: { sanctum: 6, lake: 4, prism: 3 } },
    outro: "Light blazes through every drowned hall as Abyssalux rises and the Prophecy is fulfilled at last. Oracle Maris weeps for joy — the Sunken Sanctum sings again, whole, and you are the hero of the tides.",
  },
  {
    id: "q-clockwork", name: "The Clockwork Heart", color: "#c69a3c", icon: "⚙️",
    house: { id: "house-workshop", name: "Cog's Workshop", tx: 48, ty: 26, deco: "house1" },
    giverName: "Tinker Cog", giverAv: { skin: 3, hair: 5, shirt: 7, pants: 2, hat: "cap", glasses: "square" },
    intro: "In the age of gears, the great Aurumaton kept the very seasons turning true — until it wound down and its parts were scattered to the ends of the world. I have spent my whole life gathering the pieces. Help me find the last few, solve the locks that guard its heart, and together we'll wake the golden wonder!",
    steps: [
      { kind: "math", level: 3, giverLine: "First, prove you can keep time. A tinkerer lives or dies by arithmetic — solve this!",
        text: "Solve Tinker Cog's timing puzzle." },
      { kind: "item", item: "brass-gear", itemName: "Brass Gear", emoji: "⚙️", count: 3, zone: "ridge",
        text: "Salvage 3 Brass Gears from the old machines rusting on Ember Ridge." },
      { kind: "item", item: "copper-coil", itemName: "Copper Coil", emoji: "🔩", count: 3, zone: "cavern",
        text: "Mine 3 Copper Coils from deep in the Gleamcave Hollows." },
      { kind: "catch", creature: "cogsprite", zone: "meadow",
        text: "A living gear — a Cogsprite — ticks around Willowmere Meadow. Catch it; it belongs to the machine." },
      { kind: "talk", npc: "npc-miner", npcName: "Miner Quill",
        line: "This humming crystal? It's been ticking in my pocket for weeks and driving me batty. The automaton's core, you say? Here — take it, and welcome!",
        text: "Miner Quill dug up the automaton's humming core crystal — go collect it from him near the caverns." },
      { kind: "riddle", prompt: "The more of me you take, the more you leave behind. What am I?",
        answers: ["footsteps", "footprints", "steps"], hint: "You make them as you walk.",
        giverLine: "The heart's final lock is a riddle, not a number. Answer it and the core will open.",
        text: "Return to Tinker Cog and answer the heart's final riddle." },
      { kind: "item", item: "aether-spring", itemName: "Aether Spring", emoji: "✨", count: 3, zone: "sanctum",
        text: "The mainspring needs Aether, found only in the Sunken Sanctum (through the Tidewhirl on Lake Lumen). Gather 3." },
      { kind: "goto", loc: "loc-clockwork", locName: "the Clockwork Vault", tx: 50, ty: 30, zone: "meadow",
        text: "Bring every part to the Clockwork Vault beside the village." },
      { kind: "boss", creature: "aurumaton", loc: "loc-clockwork", tx: 50, ty: 30, zone: "meadow",
        text: "The parts lock together with a great golden tick — the Aurumaton wakes! Catch it (its clockwork will guard it)." },
    ],
