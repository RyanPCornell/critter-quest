...
(function () {
  ...
  window.ORB_ORDER = ["meadow", "forest", "lake", "ridge", "desert", "tundra", "marsh", "cavern", "prism"];
  ...
  window.startingOrbs = function () {
    return { meadow: 6, forest: 5, lake: 5, ridge: 5, desert: 5, tundra: 4, marsh: 4, cavern: 4, prism: 2 };
  };
})();
